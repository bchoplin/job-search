    ...
    <Section sectionType="gray-bg">
      ...
      {contentExpanded &&
        <>
          ...
          <p>While this data is interesting, it doesn’t paint the entire picture. It doesn’t capture my refusal to back down when things felt bleak. It can’t quantify my lack of relaxation, no matter how well things were going, because I knew nothing was guaranteed. It doesn’t include how many tears I shed, how many text messages I avoided answering, how many doom scrolls I took down my LinkedIn feed. The data below reflects only the results of my hard work. To quantify the effort feels like an exponentially depressing and unnecessary task.</p>
